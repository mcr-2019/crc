...
class CarsWithoutDriverCrudController extends CrudController
{ 
    ...
    {    
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . "/cars_without_driver");
        $this->crud->setEntityNameStrings('машина без водителя', 'машины без водителя');
    ...
    public function store(StoreRequest $request)
    {
      ...
      $request->request->set('with_driver', false);
